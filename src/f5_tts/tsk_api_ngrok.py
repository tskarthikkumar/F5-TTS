...
def process_data():
    ...
    output_wave_path = f"{output_file_name}"
...
def run_api(domain, port_no):
    public_url =  ngrok.connect(port_no,domain=domain).public_url
...
if __name__ == '__main__':
    ...
    #example api request
    #curl --location 'https://url/process' \
    #--form 'ref_audio="input/ref_audio.mp3"' \
    #--form 'ref_text=""' \
    #--form 'gen_text="TTS to speak"' \
    #--form 'speed="0.83"' \
    #--form 'seed="898789898"' \
    #--form 'response_type="file"' \
    #--form 'output_file_name="/content/output/output_audion.wav"'
